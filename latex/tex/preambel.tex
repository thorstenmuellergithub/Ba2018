...
\usepackage{pgfplots}
\usetikzlibrary{graphs, shapes, arrows, calc, positioning}
...
\usepackage[font={sf,footnotesize},labelfont={footnotesize,bf}]{caption} % Beschriftungen %param hang, deleted
